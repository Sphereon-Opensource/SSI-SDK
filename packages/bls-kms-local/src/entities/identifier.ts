import { Entity, Column, Connection, PrimaryColumn, BaseEntity, OneToMany, ManyToMany, Index, BeforeInsert, BeforeUpdate } from 'typeorm'
import { Key } from './key'
...
export class Identifier extends BaseEntity {
   ...
   * @param where
   */
  async getLatestClaimValue(dbConnection: Promise<Connection>, where: { type: string }): Promise<string | null | undefined> {

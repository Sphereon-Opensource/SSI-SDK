...
## [0.40.1](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/compare/v0.40.0...v0.40.1) (2026-07-03)

**Note:** Version bump only for package @sphereon/ssi-sdk-ext.jwt-service

# [0.40.0](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/compare/v0.39.0...v0.40.0) (2026-06-05)
...
- ensure compatibility in JWK handling and schema references updates ([1ee9ecf](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/1ee9ecfded46e16380f9c951f1e63f69ac002dbe))

### Features

- add ITB testbed dc+sd-jwt credential tests and remove redundant verification logic in did mode ([84a6783](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/84a67832770f85b19d937eed6a7863f0cd04964e))
- oid4vc 1.0, mdoc support, update dev and runtime dependencies to latest versions, and clean up imports ([ca1dded](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/ca1dded9668b2f74efa303ab47b54d9f15f97238))
...
# [0.37.0](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/compare/v0.36.0...v0.37.0) (2026-01-30)

**Note:** Version bump only for package @sphereon/ssi-sdk-ext.jwt-service

# [0.36.0](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/compare/v0.34.0...v0.36.0) (2025-11-19)

### Features

- Add support for VCDM2 SDJWT ([322c421](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/322c4218f587203523e0620fe42ec96486724f79))
- Merge crypto extension modules now the build process is faster and we have turbo. Means we will have consistent versions between SDK and crypto extension modules ([6a366b9](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/6a366b905f34e154bba90d4ab20d9b1736336d01))

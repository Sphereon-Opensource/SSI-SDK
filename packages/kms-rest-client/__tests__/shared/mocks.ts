...
export const createMocks = (): void => {
  ...
  nock('https://ssi-backend.sphereon.com')
    .post('/resolvers/jose_cose_resolver/resolve', ResolvePublicKeyToJSONTyped({
      keyInfo: {
        key: {
          kty: "EC",
  ...
  nock('https://ssi-backend.sphereon.com')
    .post('/signatures/raw/verify', VerifyRawSignatureToJSONTyped({
      keyInfo: {
        key: {
          kty: "EC",
          kid: "00-qTBov6GxjPSuMNxnk876cMP0JKjbwl4ZyN_sY2tE",
  ...
  nock('https://ssi-backend.sphereon.com')
    .delete('/keys/Gxq2tXSNl_kp8tKHNzIlO7jQDM-aYcgn1aewGW8Yby4')
    .times(1)
    .reply(204)

  nock('https://ssi-backend.sphereon.com')
    .get('/providers/test-software')
    .times(1)
    .reply(200, {
      providerId: "test-software",
      type: "SOFTWARE"
  ...
  nock('https://ssi-backend.sphereon.com')
    .post('/providers/test-software/keys', StoreKeyToJSONTyped({
      keyInfo: {
        key: {
          kty: "EC",
          kid: "00-qTBov6GxjPSuMNxnk876cMP0JKjbwl4ZyN_sY2tE",
  ...
  nock('https://ssi-backend.sphereon.com')
    .delete('/providers/test-software/keys/Gxq2tXSNl_kp8tKHNzIlO7jQDM-aYcgn1aewGW8Yby4')
    .times(1)
    .reply(204)
}

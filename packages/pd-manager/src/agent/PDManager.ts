...
export class PDManager implements IAgentPlugin {
  ...
  private async handleOverwriteMode(
    ...
    if (existingItem) {
      ...
      const newDefinitionItem = {
        ...definitionItem,
        name: definitionItem.name ?? definitionItem.definitionPayload?.name,
        purpose: definitionItem.purpose ?? definitionItem.definitionPayload?.purpose,
      }
  ...
  private async handleOverwriteLatestMode(
    ...
    if (latestVersionItem) {
      ...
      latestVersionItem.name = definitionItem.definitionPayload?.name ?? definitionItem.name
      latestVersionItem.purpose = definitionItem.definitionPayload?.purpose ?? definitionItem.purpose

...
describe('Issuer Auth', (): void => {
  ...
  it('should decode and encode ISO Test Vector', () => {
    const coseSign = com.sphereon.crypto.cose.CoseSign1Cbor.Static.cborDecode<any>(decodeFrom(iso18013_5_IssuerAuthTestVector, Encoding.HEX))
  ...
  it('should verify IETF Test Vector', async () => {
    ...
    const issuerAuth = com.sphereon.crypto.cose.CoseSign1Cbor.Static.cborDecode(decodeFrom(ietfTestVector, Encoding.HEX)) as CoseSign1Cbor<any>
  ...
  it('should verify Issuer Signed Test Vector', async () => {
    ...
    const issuerSigned = com.sphereon.mdoc.data.device.IssuerSignedCbor.Static.cborDecode(decodeFrom(funkeTestVector, Encoding.HEX))
  ...
  it('should show a full flow from issuer to holder to RP', async () => {
    ...
    // RP side
    const rpDeviceResponse = com.sphereon.mdoc.data.device.DeviceResponseCbor.Static.cborDecode(decodeFrom(authResponse.vp_token, Encoding.BASE64URL))

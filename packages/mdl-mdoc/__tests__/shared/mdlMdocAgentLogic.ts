...
export default (testContext: { getAgent: () => ConfiguredAgent; setup: () => Promise<boolean>; tearDown: () => Promise<boolean> }): void => {
  describe('Certificate chain', (): void => {
    ...
    it('should validate a valid certificate SDJWT chain without providing a CA as trust anchor, but with trustRoot enabled', async () => {
      const chain = [
    ...
    it('should be verified for Funke test issuer and Funke CA', async () => {
      await expect(
        agent.x509VerifyCertificateChain({
          chain: [

...
- add dynamic trust anchor providers, enhance x509 validation, and improve logging in mdoc verification ([639db9e](https://github.com/Sphereon-OpenSource/SSI-SDK-crypto-extensions/commit/639db9e0a04f8b968c838aae053f56a88dd910be))

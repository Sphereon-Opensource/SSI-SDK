...
import { IBasicBackgroundAttributes } from '../../types/index.mjs'
import { ImageAttributesEntity, imageAttributesEntityFrom } from './ImageAttributesEntity.mjs'
...
export class BackgroundAttributesEntity extends BaseEntity {
  ...
  @Column({ name: 'color', type: 'varchar', length: 255, nullable: true, unique: false })

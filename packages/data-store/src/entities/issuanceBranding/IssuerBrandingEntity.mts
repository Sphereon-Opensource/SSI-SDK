...
import { IssuerLocaleBrandingEntity, issuerLocaleBrandingEntityFrom } from './IssuerLocaleBrandingEntity.mjs'
import { IBasicIssuerBranding, IBasicIssuerLocaleBranding } from '../../types/index.mjs'
...
export class IssuerBrandingEntity extends BaseEntity {
  ...
  @Column({ name: 'issuerCorrelationId', type: 'varchar', length: 255, nullable: false, unique: true })

...
export class CreateConnections1659463069549 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "BaseConfigEntity" ("id" varchar PRIMARY KEY NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "last_updated_at" datetime NOT NULL DEFAULT (datetime('now')), "client_id" text, "client_secret" text, "scopes" text, "issuer" text, "redirect_url" text, "dangerously_allow_insecure_http_requests" boolean, "client_auth_method" text, "identifier" text, "session_id" text, "type" varchar NOT NULL)`
    )
    await queryRunner.query(`CREATE INDEX "IDX_228953a09ee91bbac6e28b7345" ON "BaseConfigEntity" ("type") `)
    await queryRunner.query(
      `CREATE TABLE "ConnectionIdentifier" ("id" varchar PRIMARY KEY NOT NULL, "connectionType" varchar CHECK( "connectionType" IN ('did','url') ) NOT NULL, "correlation_id" text NOT NULL)`
    )
    await queryRunner.query(
      `CREATE TABLE "ConnectionMetadata" ("id" varchar PRIMARY KEY NOT NULL, "label" text NOT NULL, "value" text NOT NULL, "connectionId" varchar)`
    )
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_ConnectionMetadata" ("id" varchar PRIMARY KEY NOT NULL, "label" text NOT NULL, "value" text NOT NULL, "connectionId" varchar, CONSTRAINT "FK_6ad4b3aef7fa22859724a7daefb" FOREIGN KEY ("connectionId") REFERENCES "Connection" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    )
    await queryRunner.query(

...
export class CreateConnections1659463069549 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ConnectionIdentifier" ("id" varchar PRIMARY KEY NOT NULL, "connection_identifier" varchar NOT NULL, "correlation_id" text NOT NULL)`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "Connection" ("id" varchar PRIMARY KEY NOT NULL, "connection_type" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "last_updated_at" datetime NOT NULL DEFAULT (datetime('now')), "identifierId" varchar, "configId" varchar, "partyId" varchar, CONSTRAINT "REL_aa9063e7f7fb511f53fd7ed514" UNIQUE ("identifierId"), CONSTRAINT "REL_258311da5ac24ef56f9a67e97a" UNIQUE ("configId"))`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_Connection" ("id" varchar PRIMARY KEY NOT NULL, "connection_type" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "last_updated_at" datetime NOT NULL DEFAULT (datetime('now')), "identifierId" varchar, "configId" varchar, "partyId" varchar, CONSTRAINT "REL_aa9063e7f7fb511f53fd7ed514" UNIQUE ("identifierId"), CONSTRAINT "REL_258311da5ac24ef56f9a67e97a" UNIQUE ("configId"), CONSTRAINT "FK_aa9063e7f7fb511f53fd7ed514c" FOREIGN KEY ("identifierId") REFERENCES "ConnectionIdentifier" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_258311da5ac24ef56f9a67e97a0" FOREIGN KEY ("configId") REFERENCES "BaseConfigEntity" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_7d1cc49940483073cdc4cea2284" FOREIGN KEY ("partyId") REFERENCES "Party" ("id") ON DELETE CASCADE ON UPDATE NO ACTION)`
    )
    await queryRunner.query(
      `INSERT INTO "temporary_Connection"("id", "connection_type", "created_at", "last_updated_at", "identifierId", "configId", "partyId") SELECT "id", "connection_type", "created_at", "last_updated_at", "identifierId", "configId", "partyId" FROM "Connection"`
    )
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `INSERT INTO "Connection"("id", "connection_type", "created_at", "last_updated_at", "identifierId", "configId", "partyId") SELECT "id", "connection_type", "created_at", "last_updated_at", "identifierId", "configId", "partyId" FROM "temporary_Connection"`
    )

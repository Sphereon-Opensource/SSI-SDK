...
export class CreateConnections1659463069549 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ConnectionIdentifier" ("id" varchar PRIMARY KEY NOT NULL, "connection_identifier" varchar CHECK( "connection_identifier" IN ('did','url') ) NOT NULL, "correlation_id" text NOT NULL)`);
    ...
    await queryRunner.query(`CREATE TABLE "Party" ("id" varchar PRIMARY KEY NOT NULL, "party_name" text NOT NULL, CONSTRAINT "UQ_6645b2630829161b73f9d5ffe90" UNIQUE ("party_name"))`);

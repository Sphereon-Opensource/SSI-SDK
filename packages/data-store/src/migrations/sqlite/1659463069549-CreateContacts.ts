...
export class CreateContacts1659463069549 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
        `CREATE INDEX "IDX_BaseConfigEntity_type" ON "BaseConfigEntity" ("type")`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
        `DROP INDEX "IDX_BaseConfigEntity_type"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
        `DROP TABLE "BaseConfigEntity"`
    )
    await queryRunner.query(
        `ALTER TABLE "temporary_BaseConfigEntity" RENAME TO "BaseConfigEntity"`
    )
    await queryRunner.query(
        `CREATE INDEX "IDX_BaseConfigEntity_type" ON "BaseConfigEntity" ("type")`
    )
    ...
    await queryRunner.query(
        `DROP TABLE "CorrelationIdentifier"`
    )
    await queryRunner.query(
        `ALTER TABLE "temporary_CorrelationIdentifier" RENAME TO "CorrelationIdentifier"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
        `DROP TABLE "IdentityMetadata"`
    )
    await queryRunner.query(
        `ALTER TABLE "temporary_IdentityMetadata" RENAME TO "IdentityMetadata"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
        `INSERT INTO "temporary_Connection"("id", "type", "identityId") SELECT "id", "type", "identityId" FROM "Connection"`
    )
    await queryRunner.query(
        `DROP TABLE "Connection"`
    )
    await queryRunner.query(
        `ALTER TABLE "temporary_Connection" RENAME TO "Connection"`
    )
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
        `INSERT INTO "Connection"("id", "type", "identityId") SELECT "id", "type", "identityId" FROM "Connection"`
    )
    ...
    await queryRunner.query(
        `ALTER TABLE "IdentityMetadata" RENAME TO "temporary_IdentityMetadata"`
    )
    await queryRunner.query(
        `CREATE TABLE "IdentityMetadata" ("id" varchar PRIMARY KEY NOT NULL, "label" varchar(255) NOT NULL, "value" varchar(255) NOT NULL, "identityId" varchar)`
    )
    ...
    await queryRunner.query(
        `ALTER TABLE "CorrelationIdentifier" RENAME TO "temporary_CorrelationIdentifier"`
    )
    await queryRunner.query(
        `CREATE TABLE "CorrelationIdentifier" ("id" varchar PRIMARY KEY NOT NULL, "type" varchar CHECK( "type" IN ('did','url') ) NOT NULL, "correlation_id" text NOT NULL, "identityId" varchar, CONSTRAINT "UQ_Correlation_id" UNIQUE ("correlation_id"), CONSTRAINT "REL_CorrelationIdentifier_identityId" UNIQUE ("identityId"))`
    )

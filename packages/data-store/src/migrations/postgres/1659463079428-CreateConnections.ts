...
export class CreateConnections1659463079428 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "ConnectionIdentifier" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "connectionType" "public"."ConnectionIdentifier_connectiontype_enum" NOT NULL, "correlation_id" text NOT NULL, CONSTRAINT "PK_402720c2bc286daafb8a0b09dd3" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "ConnectionMetadata" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "label" text NOT NULL, "value" text NOT NULL, "connectionId" uuid, CONSTRAINT "PK_0c3d592dcee11e1d8e0aac9ab99" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE TABLE "Party" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" text NOT NULL, CONSTRAINT "PK_1d61626792eccfcb50ff6f7cda2" PRIMARY KEY ("id"))`
    )

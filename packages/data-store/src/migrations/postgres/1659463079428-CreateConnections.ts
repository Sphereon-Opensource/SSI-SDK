...
export class CreateConnections1659463079428 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "ConnectionIdentifier" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "connection_identifier" "public"."ConnectionIdentifier_connection_identifier_enum" NOT NULL, "correlation_id" text NOT NULL, CONSTRAINT "PK_402720c2bc286daafb8a0b09dd3" PRIMARY KEY ("id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "Party" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "party_name" text NOT NULL, CONSTRAINT "UQ_6645b2630829161b73f9d5ffe90" UNIQUE ("party_name"), CONSTRAINT "PK_1d61626792eccfcb50ff6f7cda2" PRIMARY KEY ("id"))`);

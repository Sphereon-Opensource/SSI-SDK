...
describe('Database entities tests', (): void => {
  ...
  it('Should save credential branding to database', async (): Promise<void> => {
    ...
    expect(fromDb?.localeBranding[0].logo!.type).toEqual(credentialBranding.localeBranding[0].logo!.type)
    ...
    expect(fromDb?.localeBranding[0].background!.image!.type).toEqual(credentialBranding.localeBranding[0].background!.image!.type)
  ...
  it('Should save credential locale branding to database', async (): Promise<void> => {
    ...
    expect(fromDb?.logo!.type).toEqual(localeBranding.logo!.type)
    ...
    expect(fromDb?.background!.image!.type).toEqual(localeBranding.background!.image!.type)
  ...
  it('Should save issuer branding to database', async (): Promise<void> => {
    ...
    expect(fromDb?.localeBranding[0].logo!.type).toEqual(issuerBranding.localeBranding[0].logo!.type)
    expect(fromDb?.localeBranding[0].logo!.dimensions).toBeDefined()
    ...
    expect(fromDb?.localeBranding[0].background!.image!.type).toEqual(issuerBranding.localeBranding[0].background!.image!.type)
    expect(fromDb?.localeBranding[0].background!.image!.dimensions).toBeDefined()
    expect(fromDb?.localeBranding[0].background!.image!.dimensions!.width).toEqual(

...
describe('SSI QR Code', () => {
  it('should create payload object', async () => {
    ...
    expect(payload).toMatchObject({"body": {"accept": ["siopv2+oidc4vp"], "goalCode": "streamlined-vp"}, "from": "did:key:zrfdjkgfjgfdjk", "id": "599f3638-b563-4937-9487-dfe55099d900", "type": "siopv2"})
  ...
  it('should create json value', async () => {
    ...
    expect(json).toMatch("{\"type\":\"siopv2\",\"id\":\"599f3638-b563-4937-9487-dfe55099d900\",\"from\":\"did:key:zrfdjkgfjgfdjk\",\"body\":{\"goal-code\":\"streamlined-vp\",\"accept\":[\"siopv2+oidc4vp\"]}}")
  })
  ...
  it('should url encode and decode', async () => {
    ...
    expect(urlEncoded).toMatch("eyJ0eXBlIjoic2lvcHYyIiwiaWQiOiI1OTlmMzYzOC1iNTYzLTQ5MzctOTQ4Ny1kZmU1NTA5OWQ5MDAiLCJmcm9tIjoiZGlkOmtleTp6cmZkamtnZmpnZmRqayIsImJvZHkiOnsiZ29hbC1jb2RlIjoic3RyZWFtbGluZWQtdnAiLCJhY2NlcHQiOlsic2lvcHYyK29pZGM0dnAiXX19")
    expect(base64url.decode(urlEncoded)).toMatch("{\"type\":\"siopv2\",\"id\":\"599f3638-b563-4937-9487-dfe55099d900\",\"from\":\"did:key:zrfdjkgfjgfdjk\",\"body\":{\"goal-code\":\"streamlined-vp\",\"accept\":[\"siopv2+oidc4vp\"]}}")
  })

...
export const mapCredentialToAccept = async (args: MapCredentialToAcceptArgs): Promise<MappedCredentialToAccept> => {
  ...
  console.log(`CALLING ITTTTTTTTTTTTTTTTTTT`)
  ...
  const verifiableCredential: W3CVerifiableCredential | undefined = testSDJWT//credentialResponse.credential
...
//  credential.credentialResponse.credential_subject_issuance
  ...
  const rawVerifiableCredential: VerifiableCredential = testSDJWT as unknown as VerifiableCredential //credentialResponse.credential

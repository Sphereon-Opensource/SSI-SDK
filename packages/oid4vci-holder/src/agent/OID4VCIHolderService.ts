...
export const getSupportedCredentials = async (openID4VCIClient: OpenID4VCIClient, vcFormatPreferences: Array<string>): Promise<Array<CredentialSupported>> => {
...
export const getCredentialBranding = async (supportedCredentials: Array<CredentialSupported>, context: RequiredContext): Promise<Map<string, Array<IBasicCredentialLocaleBranding>>> => {
...
export const getPreferredCredentialFormats = async (credentials: Array<CredentialSupported>, vcFormatPreferences: Array<string>): Promise<Array<CredentialSupported>> => {
...
export const selectCredentialLocaleBranding = (args: SelectAppLocaleBrandingArgs): Promise<IBasicCredentialLocaleBranding | IBasicIssuerLocaleBranding | undefined> => {
  ...
  // @ts-ignore
  return localeBranding?.find((branding: IBasicCredentialLocaleBranding | IBasicIssuerLocaleBranding)=>
...
export const verifyCredentialToAccept = async (args: VerifyCredentialToAcceptArgs): Promise<void> => {
  ...
  if (!verificationResult.result || verificationResult.error) {
    return Promise.reject(Error(verificationResult.result ? verificationResult.error : translate('oid4vci_machine_credential_verification_failed_message')));
  }
}

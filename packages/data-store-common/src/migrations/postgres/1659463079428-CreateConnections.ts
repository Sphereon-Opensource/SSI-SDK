...
export class CreateConnections1659463079428 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Party" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "alias" character varying(255) NOT NULL, "uri" character varying(255) NOT NULL, CONSTRAINT "UQ_Party_name" UNIQUE ("name"), CONSTRAINT "UQ_Party_alias" UNIQUE ("alias"), CONSTRAINT "PK_Party_id" PRIMARY KEY ("id"))`
    )

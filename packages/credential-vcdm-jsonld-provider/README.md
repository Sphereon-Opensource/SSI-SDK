...
```shell
yarn add @sphereon/ssi-sdk.credential-vcdm-jsonld-provider
```
...
```shell
POST http://localhost:7071/api/vdx-ivcs/v1/createVerifiableCredential
...
```shell
POST http://localhost:7071/api/vdx-ivcs/v1/verifyCredential

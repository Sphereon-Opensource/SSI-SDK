...
describe('@sphereon/ssi-sdk.core:encoding', () => {
    ...
    it('should encode hex to multibase base58', () => {
        ...
        expect(hexToMultibase(HEX_EXAMPLE.toUpperCase(), "Ed25519")).toEqual({value: MULTIBASE_EXAMPLE, keyType: 'Ed25519', format: MultibaseFormat.BASE58})
    })
    ...
    it('should encode multibase base58 to hex', () => {
        expect(multibaseToHex(MULTIBASE_EXAMPLE)).toEqual({
            value: HEX_EXAMPLE, format: MultibaseFormat.BASE58, keyType: "Ed25519",
        })
    })
...
describe('@sphereon/ssi-sdk.core:encoding X25519', () => {
    ...
    it('should encode hex to multibase base58', () => {
        ...
        expect(hexToMultibase(HEX_EXAMPLE.toUpperCase(), "X25519")).toEqual({value: MULTIBASE_EXAMPLE, keyType: 'X25519', format: MultibaseFormat.BASE58})
    })
    // Multibase to hex
    it('should encode multibase base58 to hex', () => {
        expect(multibaseToHex(MULTIBASE_EXAMPLE)).toEqual({
            value: HEX_EXAMPLE, format: MultibaseFormat.BASE58, keyType: "X25519",
        })
    })
})
...
describe('@sphereon/ssi-sdk.core:encoding secp256k1', () => {
    ...
    it('should encode hex to multibase base58', () => {
        ...
        expect(hexToMultibase(HEX_EXAMPLE.toUpperCase(), "Secp256k1")).toEqual({value: MULTIBASE_EXAMPLE, keyType: 'Secp256k1', format: MultibaseFormat.BASE58})
    })
    // Multibase to hex
    it('should encode multibase base58 to hex', () => {
        expect(multibaseToHex(MULTIBASE_EXAMPLE)).toEqual({
            value: HEX_EXAMPLE, format: MultibaseFormat.BASE58, keyType: "Secp256k1",
        })
    })
})
...
describe('@sphereon/ssi-sdk.core:encoding secp256r1', () => {
    ...
    it('should encode hex to multibase base58', () => {
        ...
        expect(hexToMultibase(HEX_EXAMPLE.toUpperCase(), "Secp256r1")).toEqual({value: MULTIBASE_EXAMPLE, keyType: 'Secp256r1', format: MultibaseFormat.BASE58})
    })
    // Multibase to hex
    it('should encode multibase base58 to hex', () => {
        expect(multibaseToHex(MULTIBASE_EXAMPLE)).toEqual({
            value: HEX_EXAMPLE, format: MultibaseFormat.BASE58, keyType: "Secp256r1",
        })
    })
})
...
describe('@sphereon/ssi-sdk.core:encoding RSA', () => {
    ...
    const HEX_EXAMPLE = ''
    ...
    it('should encode multibase base58 to hex', () => {
        expect(multibaseToHex(MULTIBASE_EXAMPLE)).toEqual({
            value: HEX_EXAMPLE, format: MultibaseFormat.BASE58, keyType: "RSA",
        })
    })
})

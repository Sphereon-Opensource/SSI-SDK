...
export const logger = Loggers.DEFAULT.options('sphereon:ebsi-support', {defaultLogLevel: LogLevel.DEBUG, methods: [LogMethod.CONSOLE, LogMethod.DEBUG_PKG]}).get('sphereon:ebsi-support')

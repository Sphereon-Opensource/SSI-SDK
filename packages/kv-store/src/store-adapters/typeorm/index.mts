...
import { KeyValueStoreEntity } from './entities/keyValueStoreEntity.mjs'
import { KeyValueTypeORMOptions, Options_ } from './types.mjs'
import { KeyvStore, KeyvStoredData } from '../../keyv/keyv-types.mjs'
import { IKeyValueStoreAdapter } from '../../key-value-types.mjs'
import JSONB from 'json-buffer'

export { KeyValueTypeORMOptions } from './types.mjs'
export { KeyValueStoreEntity } from './entities/keyValueStoreEntity.mjs'
export { kvStoreMigrations } from './migrations/index.mjs'
...
export async function _getConnectedDb(dbConnection: OrPromise<DataSource>): Promise<DataSource> {
  if (dbConnection instanceof Promise) {
    ...
    return await (dbConnection as DataSource).initialize()
  } else {
    return dbConnection
  }
}

...
import { ObjectUtils } from '../utils/index.mjs'
...
export class CredentialMapper {
  ...
  public static isJwtDecodedCredential(original: OriginalVerifiableCredential): boolean {
    return (original as JwtDecodedVerifiableCredential)['vc'] !== undefined && (original as JwtDecodedVerifiableCredential)['iss'] !== undefined
  }

  public static isJwtDecodedPresentation(original: OriginalVerifiablePresentation): boolean {
    return (original as JwtDecodedVerifiablePresentation)['vp'] !== undefined && (original as JwtDecodedVerifiablePresentation)['iss'] !== undefined
  }
  ...
  static detectDocumentType(
    ...
    const proofs = 'vc' in document ? document.vc.proof : 'vp' in document ? document.vp.proof : (document as IVerifiableCredential).proof
